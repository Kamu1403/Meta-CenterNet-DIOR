...
DIOR_SPLIT = dict(
    ALL_CLASSES_SPLIT1=('airplane', 'airport', 'baseballfield', 'basketballcourt',
    ...
    ALL_CLASSES_SPLIT2=('airplane', 'airport', 'baseballfield', 'basketballcourt',
                        'bridge', 'chimney', 'dam', 'Expressway-Service-area', 'Expressway-toll-station',
                        'golffield', 'groundtrackfield', 'harbor', 'overpass', 'ship', 'stadium', 'storagetank',
                        'tenniscourt', 'trainstation', 'vehicle', 'windmill'
                        ),
    ALL_CLASSES_SPLIT3=('airplane', 'airport', 'baseballfield', 'basketballcourt',
                        'bridge', 'chimney', 'dam', 'Expressway-Service-area', 'Expressway-toll-station',
                        'golffield', 'groundtrackfield', 'harbor', 'overpass', 'ship', 'stadium', 'storagetank',
                        'tenniscourt', 'trainstation', 'vehicle', 'windmill'
                        ),
    ALL_CLASSES_SPLIT4=('airplane', 'airport', 'baseballfield', 'basketballcourt',
                        'bridge', 'chimney', 'dam', 'Expressway-Service-area', 'Expressway-toll-station',
                        'golffield', 'groundtrackfield', 'harbor', 'overpass', 'ship', 'stadium', 'storagetank',
                        'tenniscourt', 'trainstation', 'vehicle', 'windmill'
                        ),
    ...
    BASE_CLASSES_SPLIT1=('airplane', 'airport', 'dam', 'Expressway-Service-area', 'Expressway-toll-station',
                         'golffield', 'groundtrackfield', 'harbor', 'overpass', 'stadium', 'storagetank',
                         'tenniscourt', 'trainstation', 'vehicle', 'windmill'
                         ),
    ...
    BASE_CLASSES_SPLIT3=('airplane', 'airport', 'baseballfield', 'basketballcourt', 'bridge', 'chimney',
                         'Expressway-Service-area', 'Expressway-toll-station', 'groundtrackfield',
                         'harbor', 'overpass', 'ship', 'stadium', 'trainstation', 'windmill'
                         ),
    BASE_CLASSES_SPLIT4=('airplane', 'airport', 'baseballfield', 'basketballcourt',
                         'bridge', 'chimney', 'dam', 'Expressway-toll-station',
                         'golffield', 'groundtrackfield', 'harbor', 'ship', 'storagetank',
                         'tenniscourt', 'vehicle'
                         )
)
...
class DIORFewShotDataset(BaseFewShotDataset):
    ...
    Args:
        classes (str | Sequence[str]): Classes for model training and
            ...
            it will load pre-defined classes in `DIORFewShotDataset`.
    ...
    def __init__(self,
        ...
        assert classes is not None, f'{self.dataset_name}: classes in ' \
                                    f'`DIORFewShotDataset` can not be None.'
...
@DATASETS.register_module()
class DIORFewShotCopyDataset(DIORFewShotDataset):
    ...
    def ann_cfg_parser(self, ann_cfg: Union[List[Dict], Dict]) -> List[Dict]:
        ...
        if isinstance(ann_cfg, dict):
            assert ann_cfg.get('data_infos', None) is not None, \
                ...
                f'DIORFewShotCopyDataset require data_infos.'
...
@DATASETS.register_module()
class DIORFewShotDefaultDataset(DIORFewShotDataset):
    """Dataset with some pre-defined DIOR annotation paths.

    :obj:`DIORFewShotDefaultDataset` provides pre-defined annotation files
    ...
    dior_benchmark = {
        ...
        for shot in [1, 2, 3, 5, 10] for split in [1, 2, 3, 4]  # for shot in [1, 2, 3, 5, 10] for split in [1, 2, 3, 4]
    }
    ...
    def ann_cfg_parser(self, ann_cfg: List[Dict]) -> List[Dict]:
        ...
        return super(DIORFewShotDataset, self).ann_cfg_parser(new_ann_cfg)
